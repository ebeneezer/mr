...
static const MRSettingsKeyDescriptor kFixedSettingsKeyDescriptors[] = {
    ...
    {"MESSAGES", MRSettingsKeyClass::Global, false},
    {"HERO_MESSAGES_ON_MESSAGELINE", MRSettingsKeyClass::Global, true},
    {"HERO_MESSAGES_IN_LOGFILE", MRSettingsKeyClass::Global, true},
    {"HERO_MESSAGES_FILE_THRESHOLD_MB", MRSettingsKeyClass::Global, true},
