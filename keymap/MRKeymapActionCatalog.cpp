...
constexpr std::array catalogDefinitions{
    ...
    mr("MR_LSP_GOTO_DEFINITION", "LSP go to definition"),
    ...
    mr("MR_LSP_SIGNATURE_HELP", "LSP signature help"),
    mr("MR_LSP_RENAME", "LSP rename"),
    mr("MR_LSP_CODE_ACTIONS", "LSP code actions"),
