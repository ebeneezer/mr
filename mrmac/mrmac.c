...
static const ProcSignature kProcSignatures[] = {
    ...
    PROC_SIG0("LSP_CODE_ACTIONS", "LSP_CODE_ACTIONS"),
    PROC_SIG0("LSP_COMPLETE", "LSP_COMPLETE"),
    PROC_SIG0("LSP_DEFINITION", "LSP_DEFINITION"),
    PROC_SIG0("LSP_HIGHLIGHT", "LSP_HIGHLIGHT"),
    PROC_SIG0("LSP_HOVER", "LSP_HOVER"),
    PROC_SIG0("LSP_REFERENCES", "LSP_REFERENCES"),
    PROC_SIG0("LSP_RENAME", "LSP_RENAME"),
    PROC_SIG0("LSP_SIGNATURE", "LSP_SIGNATURE"),
    PROC_SIG0("LSP_SYMBOLS", "LSP_SYMBOLS"),
    PROC_SIG0("LSP_WORKSPACE_SYMBOLS", "LSP_WORKSPACE_SYMBOLS"),
    ...
    PROC_SIG0("SETUP_LSP_SUPPORT", "SETUP_LSP_SUPPORT"),
...
static const BareProcStatement kBareProcStatements[] = {
    ...
    BARE_PROC("LSP_CODE_ACTIONS"),
    BARE_PROC("LSP_COMPLETE"),
    BARE_PROC("LSP_DEFINITION"),
    BARE_PROC("LSP_HIGHLIGHT"),
    BARE_PROC("LSP_HOVER"),
    BARE_PROC("LSP_REFERENCES"),
    BARE_PROC("LSP_RENAME"),
    BARE_PROC("LSP_SIGNATURE"),
    BARE_PROC("LSP_SYMBOLS"),
    BARE_PROC("LSP_WORKSPACE_SYMBOLS"),
