...
class TFileCollection : public TSortedCollection {
  ...
  public:
	TFileCollection(ccIndex aLimit, ccIndex aDelta) noexcept : TSortedCollection(aLimit, aDelta) {
	}
...
class TDirCollection : public TCollection {
  ...
  public:
	TDirCollection(ccIndex aLimit, ccIndex aDelta) noexcept : TCollection(aLimit, aDelta) {
	}
