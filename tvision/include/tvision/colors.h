...
#ifndef TV_BIG_ENDIAN
	    b : 1,
	    g : 1, r : 1, bright : 1, _unused : 4;
#else
	    _unused : 4,
	    bright : 1, r : 1, g : 1, b : 1;
#endif
...
constexpr inline TColorDesired::TColorDesired(char bios) : TColorDesired(uchar(bios)) {
}

constexpr inline TColorDesired::TColorDesired(uchar bios) : _data((bios & 0xF) | (ctBIOS << 24)) {
}

constexpr inline TColorDesired::TColorDesired(int rgb) : _data((rgb & 0xFFFFFF) | (ctRGB << 24)) {
}

inline TColorDesired::TColorDesired(TColorBIOS bios) : TColorDesired(uchar(bios)) {
}

inline TColorDesired::TColorDesired(TColorRGB rgb) : TColorDesired(int(rgb)) {
}

inline TColorDesired::TColorDesired(TColorXTerm xterm) : _data(xterm | (ctXTerm << 24)) {
}
...
constexpr inline TColorAttr::TColorAttr(int bios)
    : _style(0), _fg(TColorDesired(uchar(bios)).bitCast()),
...
constexpr inline TColorAttr::TColorAttr(TColorDesired fg, TColorDesired bg, ushort style)
    : _style(style), _fg(fg.bitCast()), _bg(bg.bitCast()) {
}
...
constexpr inline TAttrPair::TAttrPair(int bios) : _attrs{uchar(bios & 0xFF), uchar(bios >> 8)} {
}

constexpr inline TAttrPair::TAttrPair(const TColorAttr &lo, const TColorAttr &hi) : _attrs{lo, hi} {
}
