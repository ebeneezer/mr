...
class TDrawBuffer {
  ...
  public:
	...
	ushort moveStr(ushort indent, TStringView str, TColorAttr attr, ushort maxStrWidth = USHRT_MAX,
	               ushort strIndent = 0) noexcept;
	ushort moveCStr(ushort indent, TStringView str, TAttrPair attrs, ushort maxStrWidth = USHRT_MAX,
	                ushort strIndent = 0) noexcept;
