...
const ushort qfBoldIsBright = 0x0001, qfBlinkIsBright = 0x0002, qfNoItalic = 0x0004,
...
struct TermCap {
	...
	static TermCap getDisplayCapabilities(ConsoleCtl &con, DisplayAdapter &display) noexcept;
};
...
class AnsiScreenWriter {
  ...
  public:
	AnsiScreenWriter(ConsoleCtl &aCon, TermCap aTermcap) noexcept : con(aCon), termcap(aTermcap) {
	}
