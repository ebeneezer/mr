...
inline TNode::TNode(TStringView aText, TNode *aChildren, TNode *aNext,
                    Boolean initialState) noexcept
    : next(aNext), text(newStr(aText)), childList(aChildren), expanded(initialState) {
}
...
typedef Boolean (*TOutlineVisitor)(TOutlineViewer *, TNode *, int, int, long, ushort, void *);
typedef Boolean (*TOutlineVisitorNoArg)(TOutlineViewer *, TNode *, int, int, long, ushort);
...
inline TOutlineViewer::TOutlineViewer(StreamableInit s) noexcept : TScroller(s) {
}
