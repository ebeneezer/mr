...
TEST(Far2l, ShouldReadFar2lInput) {
	...
	static const TestCase<TStringView, ParseResultEvent> testCases[] = {
	    ...
	    {"AQBWAAAACgAAAFYAAABL\x07",
	     {Accepted, keyDownEv(kbAltV, kbLeftCtrl | kbLeftAlt, "")}}, // UnicodeChar = 'V'
	    {"AQBWAAAACgAAAAAAAABL\x07",
	     {Accepted, keyDownEv(kbAltV, kbLeftCtrl | kbLeftAlt, "")}}, // UnicodeChar = 0
	    {"AQAIAAAACAAAAAgAAABL\x07",
	     {Accepted, keyDownEv(kbCtrlBack, kbLeftCtrl, "")}},                    // Ctrl + Back
	    {"AQAuAAAAAAAAAH8AAABL\x07", {Accepted, keyDownEv(kbDel, 0x0000, "")}}, // Del
	    ...
	    {"CQANAAAAAAAAAAAAAAAAAE0=\x07",
	     {Accepted, mouseEv({9, 13}, 0, 0, 0, 0)}}, // Button release.
	    {"AAAAAAAAAAAAAAAAAAAAAE0=\x07",
	     {Accepted, mouseEv({0, 0}, 0, 0, 0, 0)}}, // Button release.
	};
