...
const ushort kb0 = 0x0b30, kbA = 0x1e61, kbCtrlKpDiv = 0x3500, kbBiosCtrlN = 0x310e;
...
TEST(TKey, ShouldConstructProperly) {
	static constexpr TestCase<KeyCodeAndMods> testCases[] = {
	    ...
	    {{kbCtrlZ + 1}, {kbCtrlZ + 1}},
	    {{kbCtrlZ + 1, kbShift | kbCtrlShift | kbAltShift},
	     {kbCtrlZ + 1, kbShift | kbCtrlShift | kbAltShift}},
	    {{kbGrayPlus}, {kbGrayPlus}},
	    {{kbGrayPlus, kbShift | kbCtrlShift | kbAltShift},
	     {kbGrayPlus, kbShift | kbCtrlShift | kbAltShift}},
	    {{kbCtrlPrtSc}, {kbCtrlPrtSc, kbCtrlShift}},
	    {{kbCtrlPrtSc, kbShift | kbCtrlShift | kbAltShift},
	     {kbCtrlPrtSc, kbShift | kbCtrlShift | kbAltShift}},
	    {{'A'}, {'A'}},
	    {{'A', kbShift}, {'A', kbShift}},
	    ...
	    {{kbEnter, kbShift | kbCtrlShift | kbAltShift},
	     {kbEnter, kbShift | kbCtrlShift | kbAltShift}},
