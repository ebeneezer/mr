...
ConsoleAdapter &Platform::createConsole() noexcept {
	...
	if (con.isLinuxConsole())
		return LinuxConsoleAdapter::create(con, displayBuf, inputState, display,
		                                   *new NcursesInput(con, display, inputState, false));
#endif // __linux__
	return UnixConsoleAdapter::create(con, displayBuf, inputState, display,
	                                  *new NcursesInput(con, display, inputState, true));
#endif // _WIN32
}
