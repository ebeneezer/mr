...
TermCap TermCap::getDisplayCapabilities(ConsoleCtl &con, DisplayAdapter &display) noexcept {
	TermCap termcap{};
...
static void convertColor(TColorDesired, TermColor &, TColorAttr::Style &, const TermCap &,
                         bool) noexcept;
...
static constexpr ColorConverter colorConverters[TermCapColorCount] = {
    {convertNoColor}, {convertIndexed8}, {convertIndexed16}, {convertIndexed256}, {convertDirect},
};

static inline void convertColor(TColorDesired c, TermColor &resultColor,
                                TColorAttr::Style &resultStyle, const TermCap &termcap,
                                bool isFg) noexcept {
...
static inline void writeFlag(char *&p, TermAttr attr, TermAttr lastAttr, ushort mask,
                             const char *const OnOff[2]) noexcept {
...
static constexpr const char *boldOnOff[2] = {"1", "22"}, *italicOnOff[2] = {"3", "23"},
                            *underlineOnOff[2] = {"4", "24"}, *blinkOnOff[2] = {"5", "25"},
                            *reverseOnOff[2] = {"7", "27"}, *strikeOnOff[2] = {"9", "29"};

static inline char *writeAttributes(const TermAttr &attr, const TermAttr &lastAttr,
                                    char *p) noexcept {
	push(p, CSI);
...
static colorconv_r convertIndexed8(TColorDesired color, const TermCap &termcap,
                                   bool isFg) noexcept {
...
static colorconv_r convertIndexed256(TColorDesired color, const TermCap &termcap,
                                     bool isFg) noexcept {
	if (color.isXTerm()) {
		uint8_t idx = color.asXTerm();
		return {{idx, TermColor::Indexed}};
