...
const int SignalHandler::handledSignals[HandledSignalCount] = {SIGINT, SIGQUIT, SIGILL,  SIGABRT,
                                                               SIGFPE, SIGSEGV, SIGTERM, SIGTSTP};
...
template <class T> static inline bool isCustomHandler(T &&handler) {
	return (void *)handler != (void *)SIG_DFL && (void *)handler != (void *)SIG_IGN;
}
