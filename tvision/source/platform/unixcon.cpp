...
inline UnixConsoleAdapter::UnixConsoleAdapter(DisplayAdapter &aDisplay, InputAdapter &aInput,
                                              ConsoleCtl &aCon, DisplayBuffer &aDisplayBuf,
                                              InputState &aInputState,
                                              SigwinchHandler *aSigwinch) noexcept
    : ConsoleAdapter(aDisplay, {&aInput, aSigwinch}), con(aCon), displayBuf(aDisplayBuf),
      inputState(aInputState), sigwinch(aSigwinch), input(aInput) {
...
UnixConsoleAdapter &UnixConsoleAdapter::create(ConsoleCtl &con, DisplayBuffer &displayBuf,
