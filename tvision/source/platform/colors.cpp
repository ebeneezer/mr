...
static constexpr HCL RGBtoHCL(uint8_t R, uint8_t G, uint8_t B) noexcept {
...
static constexpr constarray<uint8_t, 256> initXTerm256toXTerm16LUT() noexcept {
...
static constexpr uint32_t pack(uint8_t R, uint8_t G, uint8_t B) noexcept {
	return (((R << 8) | G) << 8) | B;
};

static constexpr constarray<uint32_t, 256> initXTerm256toRGBLUT() noexcept {
	// Indices 16..255 only.
...
extern constexpr constarray<uint8_t, 256> XTerm256toXTerm16LUT = initXTerm256toXTerm16LUT();
