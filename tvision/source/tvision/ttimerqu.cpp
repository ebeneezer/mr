...
TTimerQueue::TTimerQueue() noexcept : getTimeMs(THardwareInfo::getTickCountMs), first(0) {
}

TTimerQueue::TTimerQueue(TTimePoint (&aGetTimeMs)()) noexcept : getTimeMs(aGetTimeMs), first(0) {
}
