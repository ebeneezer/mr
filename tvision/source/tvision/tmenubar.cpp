...
TMenuBar::TMenuBar(const TRect &bounds, TMenu *aMenu) noexcept : TMenuView(bounds) {
	menu = aMenu;
	growMode = gfGrowHiX;
	options |= ofPreProcess;
}

TMenuBar::TMenuBar(const TRect &bounds, TSubMenu &aMenu) noexcept : TMenuView(bounds) {
