...
TDeskInit::TDeskInit(TBackground *(*cBackground)(TRect)) noexcept : createBackground(cBackground) {
}
...
TDeskTop::TDeskTop(StreamableInit) noexcept : TDeskInit(0), TGroup(streamableInit) {
	tileColumnsFirst = False;
}
