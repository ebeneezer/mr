...
TStrIndexRec::TStrIndexRec() noexcept : count(0) {
}

TStrListMaker::TStrListMaker(ushort aStrSize, ushort aIndexSize) noexcept
    : strPos(0), strSize(aStrSize), strings(new char[aStrSize]), indexPos(0), indexSize(aIndexSize),
...
TStringList::TStringList(StreamableInit) noexcept : basePos(0), indexSize(0), index(0) {
}
#endif
