...
TPXPictureValidator::TPXPictureValidator(TStringView aPic, Boolean autoFill) : TValidator() {
	pic = newStr(aPic);
	if (autoFill)
		options |= voFill;
...
TStringLookupValidator::TStringLookupValidator(StreamableInit s) noexcept : TLookupValidator(s) {
}
