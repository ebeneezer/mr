...
TStreamableClass::TStreamableClass(const char *n, BUILDER b, int) noexcept : name(n), build(b) {
	pstream::initTypes();
...
fpstream::fpstream(const char *name, pstream::openmode omode) : fpbase(name, omode | ios::binary) {
}
