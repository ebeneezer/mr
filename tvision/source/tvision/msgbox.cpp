...
static const char *buttonName[] = {MsgBoxText::yesText, MsgBoxText::noText, MsgBoxText::okText,
...
ushort messageBoxRect(const TRect &r, ushort aOptions, const char *fmt, ...) noexcept {
	...
	va_start(argptr, fmt);
	char *msg = vFormatStr(fmt, argptr);
	va_end(argptr);
...
ushort inputBoxRect(const TRect &bounds, TStringView Title, TStringView aLabel, char *s,
