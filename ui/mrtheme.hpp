...
enum MRTokenType { tkNormal = 1, tkKeyword = 2, tkString = 3, tkComment = 4, tkError = 5 };
...
class MRThemeRegistry {
  private:
	...
	MRThemeRegistry() {
		...
		MRTheme multiEditTheme = {{0x13, 0x13, 0x1B, 0x13, 0x13, 0x13, 0x13,
		                           0x13, // Rahmen (Cyan auf Blau)
		                           0x1F, 0x1E, 0x1A, 0x1B, 0x1C, 0x30, 0x1F,
		                           0x1F, // Inhalt (Weiß/Gelb auf Blau, 0x30 für Selektion)
		                           '\0'}};
