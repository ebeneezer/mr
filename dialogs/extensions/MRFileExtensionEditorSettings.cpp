...
static const char *const kCodeLanguageChoices[] = {"None", "Automatic", "C", "C++", "Python", "JavaScript", "TypeScript", "TSX", "Bash", "zsh", "fish", "JSON", "YAML", "XML", "Perl", "Swift", "Rust", "Go", "Pascal", "Kotlin", "C#", "systemd et al."};
