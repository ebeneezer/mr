...
void updateAppCommandState(int desktopCount, bool cyclicVirtualDesktops) {
	...
	setCommandEnabled(cmMrDebugClearOutput, hasWindow && ((state.isCommunicationWindow && !state.hasExternalIoTasks) || state.isLogWindow));
	setCommandEnabled(cmMrDebugFindNextCompilerError, state.hasCompilerProblems);
	setCommandEnabled(cmMrDebugFindPreviousCompilerError, state.hasCompilerProblems);
	...
	setCommandEnabled(cmMrTextMatchBraceOrParen, hasEditor);
	setCommandEnabled(cmMrTextLocalOutline, hasEditor);
