...
TSubMenu *createOtherMenu() {
	return &(*new TSubMenu("~O~ther", kbAltO) + *createInstallationAndSetupMenuItem() + newLine() + *new TMenuItem("~B~uild current file", cmMrOtherBuildCurrentFile, kbF9, hcNoContext, "F9") + *new TMenuItem("LSP ~D~efinition", cmMrOtherLspDefinition, kbNoKey, hcNoContext) + *new TMenuItem("LSP ~R~eferences", cmMrOtherLspReferences, kbNoKey, hcNoContext) + *new TMenuItem("LSP ~H~over", cmMrOtherLspHover, kbNoKey, hcNoContext) + *new TMenuItem("LSP co~M~plete", cmMrOtherLspComplete, kbNoKey, hcNoContext) + *new TMenuItem("LSP s~T~atus", cmMrOtherLspStatus, kbNoKey, hcNoContext) + *new TMenuItem("LSP res~U~lts", cmMrOtherLspResults, kbNoKey, hcNoContext) + *new TMenuItem("~S~top current program", cmMrOtherStopProgram, kbNoKey, hcNoContext) + *new TMenuItem("~R~estart current program", cmMrOtherRestartProgram, kbNoKey, hcNoContext) + *new TMenuItem("~C~lear current output", cmMrOtherClearOutput, kbNoKey, hcNoContext) + *new TMenuItem("next compiler error", cmMrOtherFindNextCompilerError, kbNoKey, hcNoContext) + *new TMenuItem("prev compiler error", cmMrOtherFindPreviousCompilerError, kbNoKey, hcNoContext) + *new TMenuItem("match ~P~arenthesis", cmMrOtherMatchBraceOrParen, kbAltP, hcNoContext, "AltP") + newLine() + *new TMenuItem("~A~scii table", cmMrOtherAsciiTable, kbAltA, hcNoContext, "AltA") + *new TMenuItem("~E~moji table", cmMrOtherEmojiTable, kbNoKey, hcNoContext));
}
