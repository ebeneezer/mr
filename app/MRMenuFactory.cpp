...
TSubMenu *createOtherMenu() {
	return &(*new TSubMenu("~O~ther", kbAltO) + *createInstallationAndSetupMenuItem() + newLine() + *new TMenuItem("~E~xecute program...", cmMrOtherExecuteProgram, kbShiftF9, hcNoContext, "ShiftF9") + *new TMenuItem("~B~uild current file", cmMrOtherBuildCurrentFile, kbF9, hcNoContext, "F9") + *new TMenuItem("~S~top current program", cmMrOtherStopProgram, kbNoKey, hcNoContext) + *new TMenuItem("~R~estart current program", cmMrOtherRestartProgram, kbNoKey, hcNoContext) + *new TMenuItem("~C~lear current output", cmMrOtherClearOutput, kbNoKey, hcNoContext) + *new TMenuItem("next compiler error", cmMrOtherFindNextCompilerError, kbNoKey, hcNoContext, "F8") + *new TMenuItem("prev compiler error", cmMrOtherFindPreviousCompilerError, kbNoKey, hcNoContext, "ShiftF8") + *new TMenuItem("~M~atch brace or paren", cmMrOtherMatchBraceOrParen, kbCtrlF5, hcNoContext, "CtrlF5") + newLine() + *new TMenuItem("~A~scii table", cmMrOtherAsciiTable, kbAltA, hcNoContext, "AltA") + *new TMenuItem("~E~moji table", cmMrOtherEmojiTable, kbNoKey, hcNoContext));
}
